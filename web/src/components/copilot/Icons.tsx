...
export const Icon = ({ name, className = 'h-4 w-4' }: IconProps & { name: string }) => {
  const iconMap: Record<string, React.ReactNode> = {
    message: <MessageIcon className={className} />,
    crown: <CrownIcon className={className} />,
    ...
    cpu: <CpuIcon className={className} />,
    wrench: <WrenchIcon className={className} />,
    dollar: <DollarIcon className={className} />,
    ...
    upload: <UploadIcon className={className} />,
  ...
  return iconMap[name] || <SparklesIcon className={className} />;
};
...
const CrownIcon = ({ className }: IconProps) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M12 1l3 6 6 1-5 4 2 7-6-4-6 4 2-7-5-4 6-1 3-6z" />
  </svg>
);
...
const RocketIcon = ({ className }: IconProps) => (
  ...
  >
    ...
    <path d="M12 15V9m-4 4l3-3 3 3" />
    <path d="M8 9H4m16 0h-4" />
  </svg>
);
...
const BuildingIcon = ({ className }: IconProps) => (
  ...
  >
    ...
    <path d="M9 12h6m-6 3h6m-6 3h6" />
  </svg>
);

const CpuIcon = ({ className }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
const StarIcon = ({ className }: IconProps) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <polygon points="12 2 15.09 10.26 23.77 10.5 17.39 16.16 19.54 24.5 12 18.35 4.46 24.5 6.61 16.16 .23 10.5 8.91 10.26 12 2" />
  </svg>
);
...
const BrainIcon = ({ className }: IconProps) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M9.5 2a3.5 3.5 0 0 0-3.5 3.5v12A3.5 3.5 0 0 0 9.5 21a1.5 1.5 0 0 1 1.5-1.5 1.5 1.5 0 0 1 1.5 1.5 3.5 3.5 0 0 0 3.5-3.5V5.5A3.5 3.5 0 0 0 14.5 2" />
    <path d="M5 9a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2M19 9a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2" />
  </svg>
);
